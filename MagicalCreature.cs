...
public class MagicalCreature
{
    ...
    {
        return $"{Name};{Species};{Age};{MagicPower};{MagicType};{CanFly};{DiscoveryDate:dd.MM.yyyy};{HealthPoints}";
    }
